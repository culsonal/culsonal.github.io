...
gl.canvas.width = gl.canvas.height = 700;
...
gl.uniform2f(gl.getUniformLocation(draw_pts, 'ellipse_params'), .5, .25);
gl.uniform1f(gl.getUniformLocation(draw_pts, 'ior'), .4*Math.sin(itr/50)+.5);
